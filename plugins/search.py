...
def init(client_instance):
    commands = [
        ".gs <flags> <query> — Google search | flags: -l<num> results, -p<num> page",
        ".gis <query> — Google Image Search",
        ".grs — Google Reverse Search screenshot (reply to media)",
        ".reverse <1-10> — Reverse search & show N similar images (reply to media)",
        ".google <query> — Google Search button"
    ]
    description = "🔍 Search Tools - Google Search, Images & Reverse Search"
